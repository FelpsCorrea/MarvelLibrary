...
class SmallCreatorDetailPageState extends State<SmallCreatorDetailPage> {
  ...
  Widget build(BuildContext context) {
    return Observer(builder: (_) {
      return store.currentCreator != null
          ? Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          CircularDetailThumbWidget(
                              thumbPath:
                                  "${store.currentCreator!.thumbnail!.path}.${store.currentCreator!.thumbnail!.extension}"),
                          const SizedBox(height: 24),
                          DetailTitleWidget(title: store.currentCreator!.name),
                        ],
                      ),
                    ),
                    SizedBox(height: 16),
